...
function Clientes({
  ...
  }, "Ideal: captúrala parado en el domicilio del cliente. Se usa para validar, sin bloquear, que las ventas por ruta se hicieron cerca de aquí.")), React.createElement(Row, { style: { gap: 8, marginTop: 12 } }, React.createElement(BOut, { onClick: cerrarFormularioCliente, style: { flex: 1 } }, 'Cancelar'), React.createElement(BFill, {
    onClick: save,
    style: { flex: 1 }
